        ...
        <section className="bg-white -100">
            <div className="container mx-auto flex flex-col items-center text-center py-16">
                <div className="md:flex justify-between">
                    <div>
                        <h1 className="text-4xl md:mt-12 font-bold text-black -700">Claim Your Medical Compensation</h1>
                        <h1 className="text-2xl mt-4 font-bold text-gray-800"> What is Mass Tort Class Action Lawsuit?</h1>
                        ...
                        <div className="mt-8 space-x-4">
                            <Link href='/get-help'>
                                <button className="bg-green-800 text-white py-2 px-6 rounded-lg">Learn More</button>
                            </Link>
